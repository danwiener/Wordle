...
public partial class MainPage : ContentPage
{
	...
	protected override async void OnAppearing()
	{
		...
		fiveTwo.IsEnabled = false;
		oneThree.IsEnabled = false;
		twoThree.IsEnabled = false;
		threeThree.IsEnabled = false;
		fourThree.IsEnabled = false;
		fiveThree.IsEnabled = false;
		oneFour.IsEnabled = false;
		oneFive.IsEnabled = false;
		oneSix.IsEnabled = false;
		twoSix.IsEnabled = false;
		threeSix.IsEnabled = false;
		fourSix.IsEnabled = false;
		fiveSix.IsEnabled = false;
	}

	private void OnQClicked(object sender, EventArgs e)
	{
